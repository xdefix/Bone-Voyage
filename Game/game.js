...
Game.bone = function(x, y) {

  Game.MovingObject.call(this, x, y, 14, 16);
  Game.Animator.call(this, Game.bone.prototype.frame_sets["twirl"], 15);
...
Object.assign(Game.bone.prototype, Game.Animator.prototype);
Object.assign(Game.bone.prototype, Game.Object.prototype);
Game.bone.prototype.constructor = Game.bone;
...
Game.TileSet = function(columns, tile_size) {
  ...
  this.frames = [
    new f(199, 175, 25, 25, -4, -9), // idle-left
    new f(74, 175, 25, 25, -4, -9), // jump-left

    new f(174, 175, 25, 25, -4, -9),
    new f(149, 175, 25, 25, -4, -9),
    new f(124, 175, 25, 25, -4, -9),
    new f(99, 175, 25, 25, -4, -9), // walk-left

    new f(0, 200, 25, 25, -4, -9), // idle-right
    new f(125, 200, 25, 25, -4, -9), // jump-right

    new f(25, 200, 25, 25, -4, -9),
    new f(50, 200, 25, 25, -4, -9),
    new f(75, 200, 25, 25, -4, -9),
    new f(100, 200, 25, 25, -4, -9), // walk-right

    new f(150, 200, 25, 25),
    new f(175, 200, 25, 25), // bone

    new f(200, 205, 25, 4, -4, 10),
    new f(200, 213, 25, 4, -4, 10),
    new f(200, 221, 25, 4, -4, 10) // grass
  ];
...
Game.World = function(friction = 0.85, gravity = 2) {
  ...
  this.tile_set  = new Game.TileSet(9, 25);
...
Game.World.prototype = {
  ...
  setup:function(zone) {
    ...
    for (let index = zone.bones.length - 1; index > -1; -- index) {

      let bone = zone.bones[index];
      this.bones[index] = new Game.bone(bone[0] * this.tile_set.tile_size + 5, bone[1] * this.tile_set.tile_size - 2);
  ...
  update:function() {
    ...
    for (let index = this.bones.length - 1; index > -1; -- index) {
      ...
      if (bone.collideObject(this.player)) {
